...
namespace eQuantic.Core.Ioc.Scanning
{
    ...
    public class TypeSet
    {
        ...
        /// <summary>
        /// For diagnostic purposes, explains which assemblies were scanned as part of this TypeSet,
        /// including failures
        /// </summary>
        ...
        /// <summary>
        /// Find any types in this TypeSet that match any combination of the TypeClassification
        /// enumeration values
        /// </summary>
